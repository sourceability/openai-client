...
class CreateChatCompletionFunctionResponse extends ArrayObject
{
     ...
     *
     * @var CreateChatCompletionFunctionResponseChoicesItem[]
     */
     ...
     * @param CreateChatCompletionFunctionResponseChoicesItem[] $choices A list of chat completion choices. Can be more than one if `n` is greater than 1.
     ...
     * A list of chat completion choices. Can be more than one if `n` is greater than 1.
     *
     * @return CreateChatCompletionFunctionResponseChoicesItem[]
     */
     ...
     * A list of chat completion choices. Can be more than one if `n` is greater than 1.
     *
     * @param CreateChatCompletionFunctionResponseChoicesItem[] $choices
     */
