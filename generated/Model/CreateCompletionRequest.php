...
class CreateCompletionRequest extends ArrayObject
{
     ...
     *
     * @var string|string[]|int[]|int[][]|null
     */
     ...
     *                       Determinism is not guaranteed, and you should refer to the `system_fingerprint` response parameter to monitor changes in the backend.
     * @param string|string[]|null $stop Up to 4 sequences where the API will stop generating further tokens. The returned text will not contain the stop sequence.
     * @param string|null $suffix The suffix that comes after a completion of inserted text.
     * @param string $user A unique identifier representing your end-user, which can help OpenAI to monitor and detect abuse. [Learn more](/docs/guides/safety-best-practices/end-user-ids).
     * @param string|string[]|int[]|int[][]|null $prompt The prompt(s) to generate completions for, encoded as a string, array of strings, array of tokens, or array of token arrays.
     ...
     */
    public function __construct($model = null, $logitBias = null, $logprobs = null, $seed = null, $stop = null, $suffix = null, $user = null, $prompt = '<|endoftext|>', $bestOf = 1, $echo = false, $frequencyPenalty = 0, $maxTokens = 16, $n = 1, $presencePenalty = 0, $stream = false, $temperature = 1, $topP = 1)
    {
        if ($model !== null) {
            $this->setModel($model);
        }
     ...
     *
     * @return string|string[]|int[]|int[][]|null
     */
     ...
     *
     * @param string|string[]|int[]|int[][]|null $prompt
     */
