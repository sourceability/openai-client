...
class CreateCompletionRequest extends ArrayObject
{
     ...
     * @param mixed $prompt The prompt(s) to generate completions for, encoded as a string, array of strings, array of tokens, or array of token arrays.
     ...
     */
    public function __construct(?string $model = null, mixed $prompt = '<|endoftext|>', ?string $suffix = null, ?int $maxTokens = 16, ?float $temperature = 1, ?float $topP = 1, ?int $n = 1, ?bool $stream = false, ?int $logprobs = null, ?bool $echo = false, mixed $stop = null, ?float $presencePenalty = 0, ?float $frequencyPenalty = 0, ?int $bestOf = 1, ?array $logitBias = null, ?string $user = null)
    {
        $this->model = $model;
        $this->prompt = $prompt;
        $this->suffix = $suffix;
