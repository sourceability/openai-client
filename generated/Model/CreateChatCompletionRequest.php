...
class CreateChatCompletionRequest extends ArrayObject
{
     ...
     * @param int|null $maxTokens The maximum number of tokens allowed for the generated answer. By default, the number of tokens the model can return will be (4096 - prompt tokens).
     ...
     */
    public function __construct($model = null, $messages = null, $temperature = 1, $topP = 1, $n = 1, $stream = false, mixed $stop = null, $maxTokens = null, $presencePenalty = 0, $frequencyPenalty = 0, $logitBias = null, $user = null)
    {
        if ($model !== null) {
            $this->setModel($model);
        }
