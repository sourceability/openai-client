...
class CreateChatCompletionRequest extends ArrayObject
{
     ...
     */
    public function __construct($model = null, $messages = null, $temperature = 1, $topP = 1, $n = 1, $stream = false, mixed $stop = null, $presencePenalty = 0, $frequencyPenalty = 0, $logitBias = null, $user = null)
    {
        if ($model !== null) {
            $this->setModel($model);
        }
