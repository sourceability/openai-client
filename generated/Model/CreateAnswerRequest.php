...
class CreateAnswerRequest
{
    ...
    /**
     * @param string $model ID of the model to use for completion. You can select one of `ada`, `babbage`, `curie`, or `davinci`.
     * @param string $question Question to get answered.
     * @param string[][] $examples List of (question, answer) pairs that will help steer the model towards the tone and answer format you'd like. We recommend adding 2 to 3 examples.
     * @param string $examplesContext A text snippet containing the contextual information used to generate the answers for the `examples` you provide.
     ...
     */
    public function __construct($model = null, $question = null, $examples = null, $examplesContext = null, $documents = null, $file = null, $searchModel = 'ada', $maxRerank = 200, $temperature = 0, $logprobs = null, $maxTokens = 16, $stop = null, $n = 1, $logitBias = null, $returnMetadata = false, $returnPrompt = false, $expand = [], $user = null)
    {
        if ($model !== null) {
            $this->setModel($model);
        }
        ...
        if ($examplesContext !== null) {
            $this->setExamplesContext($examplesContext);
        }
        if ($documents !== null) {
