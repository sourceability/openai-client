...
class CreateEdit extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(CreateEditRequest $requestBody)
    {
    ...
    {
        if ($this->body instanceof CreateEditRequest) {
            return [[
    ...
    /**
     * @return null|CreateEditResponse
     */
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (($contentType === null) === false && ($status === 200 && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, CreateEditResponse::class, 'json');
        }
    }
}
