...
class CancelRun extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
    ...
    {
        return str_replace(['{thread_id}', '{run_id}'], [$this->thread_id, $this->run_id], '/threads/{thread_id}/runs/{run_id}/cancel');
    }
