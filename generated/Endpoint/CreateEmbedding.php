...
class CreateEmbedding extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(CreateEmbeddingRequest $requestBody)
    {
    ...
    {
        if ($this->body instanceof CreateEmbeddingRequest) {
            return [[
    ...
    /**
     * @return null|CreateEmbeddingResponse
     */
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (($contentType === null) === false && ($status === 200 && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, CreateEmbeddingResponse::class, 'json');
        }
    }
}
