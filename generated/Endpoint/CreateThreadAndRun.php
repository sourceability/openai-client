...
class CreateThreadAndRun extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(CreateThreadAndRunRequest $requestBody)
    {
    ...
    {
        if ($this->body instanceof CreateThreadAndRunRequest) {
            return [[
