...
class CreateModeration extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(CreateModerationRequest $requestBody)
    {
    ...
    {
        if ($this->body instanceof CreateModerationRequest) {
            return [[
    ...
    /**
     * @return null|CreateModerationResponse
     */
    protected function transformResponseBody(ResponseInterface $response, SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (($contentType === null) === false && ($status === 200 && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, CreateModerationResponse::class, 'json');
        }
    }
}
