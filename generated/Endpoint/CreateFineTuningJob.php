...
class CreateFineTuningJob extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(CreateFineTuningJobRequest $requestBody)
    {
    ...
    {
        if ($this->body instanceof CreateFineTuningJobRequest) {
            return [[
