...
class RunStepDetailsToolCallsFunctionObjectFunctionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === RunStepDetailsToolCallsFunctionObjectFunction::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === RunStepDetailsToolCallsFunctionObjectFunction::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new RunStepDetailsToolCallsFunctionObjectFunction();
