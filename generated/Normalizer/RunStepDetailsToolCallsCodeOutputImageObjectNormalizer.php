...
class RunStepDetailsToolCallsCodeOutputImageObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === RunStepDetailsToolCallsCodeOutputImageObject::class;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && $data::class === RunStepDetailsToolCallsCodeOutputImageObject::class;
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new RunStepDetailsToolCallsCodeOutputImageObject();
