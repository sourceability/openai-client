...
class CreateEditResponseChoicesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'Sourceability\\OpenAIClient\\Generated\\Model\\CreateEditResponseChoicesItem';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'Sourceability\\OpenAIClient\\Generated\\Model\\CreateEditResponseChoicesItem';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \Sourceability\OpenAIClient\Generated\Model\CreateEditResponseChoicesItem();
        ...
        if (\array_key_exists('logprobs', $data) && $data['logprobs'] !== null) {
            $object->setLogprobs($this->denormalizer->denormalize($data['logprobs'], 'Sourceability\\OpenAIClient\\Generated\\Model\\CreateEditResponseChoicesItemLogprobs', 'json', $context));
            unset($data['logprobs']);
        }
